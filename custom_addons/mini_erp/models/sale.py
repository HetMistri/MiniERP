...
class SaleOrder(models.Model):
    ...
    _sql_constraints = [
        ('name_uniq', 'unique(name)', 'The Sales Order reference must be unique!'),
    ]
...
class SaleOrderLine(models.Model):
    ...
    delivered_qty = fields.Float(string='Delivered Qty', default=0.0, required=True)
    reserved_qty = fields.Float(string='Reserved Qty', default=0.0, required=True)
